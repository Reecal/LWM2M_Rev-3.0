...
#define COAP_C_ERR_NOT_ALLOWED			0x85
#define COAP_C_ERR_NOT_ACCEPTABLE		0x86
#define COAP_C_ERR_REQ_ENTRY_INCOMPLETE	0x88
#define COAP_C_ERR_REQ_ENTITY_TOO_LARGE	0x8D

#define COAP_S_ERR_INTERNAL_ERR			0xA0
#define COAP_S_ERR_NOT_IMPLEMENTED		0xA1
#define COAP_S_ERR_BAD_GATEWAY			0xA2
#define COAP_S_ERR_SERVICE_UNAVAILABLE	0xA3
#define COAP_S_ERR_GATEWAY_TIMEOUT		0xA4
